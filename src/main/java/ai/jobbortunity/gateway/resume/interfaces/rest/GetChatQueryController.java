package ai.jobbortunity.gateway.resume.interfaces.rest;

import ai.jobbortunity.gateway.resume.application.exception.ApplicationException;
import ai.jobbortunity.gateway.resume.application.query.InternalErrorQueryResult;
import ai.jobbortunity.gateway.resume.application.query.QueryDispatcher;
import ai.jobbortunity.gateway.resume.application.query.GetChatQuery;
import ai.jobbortunity.gateway.resume.application.query.QueryResult;
