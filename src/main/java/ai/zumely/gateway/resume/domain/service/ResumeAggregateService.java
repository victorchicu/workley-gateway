package ai.zumely.gateway.resume.domain.service;

import ai.zumely.gateway.resume.domain.aggregate.ResumeAggregate;
import ai.zumely.gateway.resume.domain.event.DomainEvent;
import ai.zumely.gateway.resume.infrastructure.eventstore.ResumeAggregateSnapshot;
import ai.zumely.gateway.resume.infrastructure.eventstore.ResumeEventStore;
import ai.zumely.gateway.resume.infrastructure.eventstore.SnapshotStrategy;
