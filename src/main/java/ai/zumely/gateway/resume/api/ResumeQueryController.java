package ai.zumely.gateway.resume.api;

import ai.zumely.gateway.resume.api.dto.ResumeReadModelDto;
import ai.zumely.gateway.resume.application.QueryDispatcher;
import ai.zumely.gateway.resume.domain.model.impl.ResumeReadModel;
import ai.zumely.gateway.resume.api.exception.ResumeNotFoundApiException;
