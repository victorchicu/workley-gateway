...
import ai.workley.gateway.auth.config.AuthenticationCookieProperties;
import ai.workley.gateway.auth.config.AuthenticatedJwtWebFilter;
import ai.workley.gateway.auth.model.AuthenticationError;
import ai.workley.gateway.auth.model.AuthenticationRequest.*;
import ai.workley.gateway.auth.model.AuthenticationResponse;
import ai.workley.gateway.auth.model.AuthenticationResponse.MeResponse;
